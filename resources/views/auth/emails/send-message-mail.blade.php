                ...
                <tbody>
                    <tr>
                        <td style="text-align: center; font-size: 16px; padding-top: 20px;">
                            ...
                            <p style="padding: 0px 10px;"><strong>You have received a new message from  <span style="color: #0378B5;"> {{$data['message']}}</span></strong></p>
                            <p style="padding: 0px 10px;">To view the message please log in to your account dashboard by clicking the button below.</p>
