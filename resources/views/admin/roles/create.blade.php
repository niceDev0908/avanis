...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                {!! Form::open(array('route' => 'roles.store','method'=>'POST','id'=>'frmCreateEdit')) !!}
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6"> 
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <?php foreach ($permission as $value) { ?>
                                        <div class="col-md-<?php echo $bootstrapColWidth; ?>">
                                            <label>
                                                {{ Form::checkbox('permission[]', $value->id, false, array('class' => 'class="custom-control-input"')) }}
                                                {{ $value->name }}
                                            </label>
                                        </div>
                                        <?php
                                ...
                                <!--  @foreach($permission as $value)
                                     <label>{{ Form::checkbox('permission[]', $value->id, false, array('class' => 'class="custom-control-input"')) }}
                                         {{ $value->name }}</label>
                                     <br/>
                                 @endforeach -->
                            </div>
