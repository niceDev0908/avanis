                ...
                <tbody>
                    <tr>
                        <td style="text-align: center; font-size: 16px; padding-top: 20px;">
                            ...
                            <p style="padding: 0px 10px;"><strong><span style="color: #0378B5;">{{$data['body']}}</span> has added transfer.</strong></p>
                            <p style="padding: 0px 10px;"><strong><span style="color: #0378B5;">Transfer Amount: </span>{{$currency_symbol}} {{$amount}}</strong></p>
                            <p style="padding: 0px 10px;"><strong><span style="color: #0378B5;">Transfer Date: </span>{{getFormatedDate($transfer_date)}}</strong></p>							
                            <p style="padding: 0px 10px;">To view the full detail of transfer please log in to your account dashboard and view details.</p>
